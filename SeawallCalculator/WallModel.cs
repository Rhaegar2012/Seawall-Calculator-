...
namespace SeawallCalculator
{
    ...
    class WallModel:ListFunctions
    {
        ...
        public (string, string, string,string,string,string,string,string,string,string,
            string,string,string,string,string,string,string,string,string,bool) GetWallParameters()
        {
            this.Active_Friction_Angle = this.Active_Friction_Angle * 180 / Math.PI;
            this.Passive_Friction_Angle = this.Passive_Friction_Angle * 180 / Math.PI;
            this.Soil_to_Wall_Friction_Angle = this.Soil_to_Wall_Friction_Angle * 180 / Math.PI;
            return (this.Ground_Elevation.ToString(), this.Top_of_Pile.ToString(), this.Mudline_Depth.ToString(),this.Ground_Water_Depth.ToString(),this.Open_Water_Level.ToString(),
                ...
                this.PilesSpacing.ToString(),this.SlopeOfBatteredPiles.ToString(),this.LateralCapacityPiles.ToString(),this.TargetSafetyFactor.ToString(),this.Cantilever);
        }
